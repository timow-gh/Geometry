...
static void BM_blaze_vec3i_add_unaligned_unpadded(benchmark::State &state) {
  blaze::StaticVector<int64_t, 3UL, blaze::columnVector, blaze::unaligned,
                      blaze::unpadded>
      a{1, 2, 3};
  blaze::StaticVector<int64_t, 3UL, blaze::columnVector, blaze::unaligned,
                      blaze::unpadded>
...
static void BM_blaze_vec3i_add(benchmark::State &state) {
  blaze::StaticVector<int64_t, 3UL, blaze::columnVector, blaze::aligned,
                      blaze::padded>
      a{1, 2, 3};
  blaze::StaticVector<int64_t, 3UL, blaze::columnVector, blaze::aligned,
                      blaze::padded>
...
static void BM_blaze_vec3f_cross(benchmark::State &state) {
  blaze::StaticVector<float_t, 3UL, blaze::columnVector, blaze::aligned,
                      blaze::padded>
      a{1, 2, 3};
  blaze::StaticVector<float_t, 3UL, blaze::columnVector, blaze::aligned,
                      blaze::padded>
