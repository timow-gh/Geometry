...
class TestLineIndices : public ::testing::Test {
protected:
  TestLineIndices()
...
TEST_F(TestLineIndices, calc_triangle_indices)
{
  ...
  std::vector<std::uint32_t> indices = Geometry::calc_line_indices<std::uint32_t>(*cuboidMesh);
