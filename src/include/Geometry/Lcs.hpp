...
class Lcs {
  ...
  public:
    ...
    CORE_NODISCARD CORE_CONSTEXPR const LinAl::Vec3Array<T, 3>& getCoordVectors() const
    {
        return m_coordVec;
    }
    ...
    CORE_NODISCARD CORE_CONSTEXPR const LinAl::Vec3<T>& getXVector() const
    {
        return m_coordVec[0];
    }
    CORE_NODISCARD CORE_CONSTEXPR const LinAl::Vec3<T>& getYVector() const
    {
        return m_coordVec[1];
    }
    CORE_NODISCARD CORE_CONSTEXPR const LinAl::Vec3<T>& getZVector() const
    {
        return m_coordVec[2];
    }
