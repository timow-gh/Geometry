...
CORE_NODISCARD CORE_CONSTEXPR T distance(const Ray<T, D>& ray, const LinAl::Vec<T, D>& vec)
{
...
template <typename T, std::size_t D>
CORE_NODISCARD CORE_CONSTEXPR T distance(const LinAl::Vec<T, D>& vec, const Ray<T, D>& ray)
{
